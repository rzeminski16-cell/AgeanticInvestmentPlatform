...
make a numeric claim about a position at all. ADR 0069 admitted the fourth record kind;
...
class TestMacroIsStillASeamAndThisIsNotIt:
    def test_the_constraint_admits_three_arms_and_not_a_published_statistic(self) -> None:
        """ADR 0069 named this and picked neither answer; nothing here picks one either.
