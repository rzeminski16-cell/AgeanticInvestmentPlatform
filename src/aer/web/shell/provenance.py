...
values — Suggested, Approved, User entered, Calculated, Source fact — and ADR 0073 refused
...
class Provenance(StrEnum):
    ...
    ATTESTED = "Attested"
    """What the operator's own book says, at a grade of evidence (ADR 0069)."""

    ASSUMED = "Assumed"
    """A value chosen rather than observed, with its justification (ADR 0046)."""

    JUDGED = "Judged"
    """A view a named person held. Never evidence for anything (ADR 0070)."""
