...
0079), so a page load walks the transactions, pools the cost, marks the holdings and
...
def _holding_row(row: portfolio_service.HoldingRow, book: Portfolio) -> dict[str, object]:
    ...
    would be a second house style nobody configured (ADR 0073) — and because the grade has
