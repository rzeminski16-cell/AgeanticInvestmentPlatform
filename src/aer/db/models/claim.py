...
**The third arm arrived with ADR 0073 and admits no unevidenced figure.** An attestation is
...
statistic as a numeric claim without inventing arithmetic to hold it. ADR 0073 named the
...
class Claim(Base):
    ...
    __table_args__ = (
        ...
        #
        # Three arms since ADR 0073, and still *exactly* one. A claim naming both a fact and
