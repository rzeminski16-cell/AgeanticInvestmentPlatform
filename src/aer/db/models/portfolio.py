...
**A portfolio is not a research request and does not inherit its clock.** ADR 0075: a
...
is a recorded calculation over a dated rate (ADR 0082), never a property of this row.
"""
...
class Portfolio(Base):
    ...
    # is exactly what the post-trade reviewer of ADR 0081 exists to read.
