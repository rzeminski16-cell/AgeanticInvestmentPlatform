...
**First — the register fixes (R1, R2, R3, R4, R6, R10).** These are the ones that decide
...
**Second — the integrity loop (R9).** A validation check that fails on its own output is
...
**Third — the approval-page surfaces (R11, R12).** The calculations table is where the
...
**Fourth — the evidence-and-selection issues (R7, R8, R13, R14).** Catalysts needs a
