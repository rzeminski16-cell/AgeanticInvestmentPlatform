...
- [`working-with-claude.md`](developers/working-with-claude.md) — one branch across two
  machines: what a cloud session can already do, the four things only your own machine can,
  what the committed permission allowlist decides and why `.env` is denied to reads.
