...
Continues from `docs/archive/phase-4-plan.md`. The phase specification — objective, deliverables,
acceptance criteria — is `docs/archive/PLAN.md` → Stage 3 → Phase 5, and it remains the authority.
...
**1. The eighteen-section spine.** `docs/archive/PLAN.md` commits to eighteen built-in sections
...
pages are server-rendered. Close-out: the Phase 5 acceptance criteria in `docs/archive/PLAN.md`
...
Close-out: `tests/test_phase5_acceptance.py` states the five `docs/archive/PLAN.md` criteria as five
