...
> stage, planned in `docs/archive/investment-os.md` and decided in ADRs 0071–0082. It was always
...
> **Tasks 11–21 (Phase 2) are in `docs/archive/phase-2-plan.md`.** This stage covers Phase 1 only. The
