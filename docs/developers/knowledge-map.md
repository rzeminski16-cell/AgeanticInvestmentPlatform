...
| `cli` | Typer entry points: serve, preflight, diagnose, rehearse-section, backup/restore, verify-artefacts, replay-run, replay-draft, purge-licensed … |
