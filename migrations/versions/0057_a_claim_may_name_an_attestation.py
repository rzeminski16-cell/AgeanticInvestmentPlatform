...
ADR 0073. The claims constraint was a two-way exclusive choice:
...
calculation. ADR 0073 named that question and picked neither answer; nothing here picks one
either.
