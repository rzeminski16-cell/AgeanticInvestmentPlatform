...
ADR 0069, and the first tables in this platform that hold data about the operator rather
...
**No ``positions`` table, and there will not be one** (ADR 0079). A holding, a cost basis, a
